...
// themes.ts
var darkPalette = ["hsla(33, 16%, 1%, 1)", "hsla(33, 16%, 6%, 1)", "hsla(33, 16%, 12%, 1)", "hsla(33, 16%, 17%, 1)", "hsla(33, 16%, 23%, 1)", "hsla(33, 16%, 28%, 1)", "hsla(33, 16%, 34%, 1)", "hsla(33, 16%, 39%, 1)", "hsla(33, 16%, 45%, 1)", "hsla(33, 16%, 50%, 1)", "hsla(0, 15%, 93%, 1)", "hsla(0, 15%, 99%, 1)"];
var lightPalette = ["hsla(33, 16%, 85%, 1)", "hsla(33, 16%, 81%, 1)", "hsla(33, 16%, 77%, 1)", "hsla(33, 16%, 73%, 1)", "hsla(33, 16%, 69%, 1)", "hsla(33, 16%, 66%, 1)", "hsla(33, 16%, 62%, 1)", "hsla(33, 16%, 58%, 1)", "hsla(33, 16%, 54%, 1)", "hsla(33, 16%, 50%, 1)", "hsla(0, 15%, 15%, 1)", "hsla(0, 15%, 1%, 1)"];
var lightShadows = {
